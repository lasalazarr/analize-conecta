...
export enum TipoPersona1 {
    ...
    ITAuditoria = 2,
    TransporteLogistica = 3
}
export enum TipoPersona2 {
    Testigo = 1,
    Jurado = 2,
    Electorero = 3,
    Abogado = 4,
    DelegadosEscrutinio = 5,
    TransportadorCarro = 6
}

/// <summary>
/// Estados Empresarias (Respetar los valores de la base de datos)
/// </summary>
export enum EstadosClienteEnum {
    Prospecto = 0,
    Nuevo = 1,
    Activo = 2,
    PosibleEgreso = 3,
...
export enum DuracionEstadosSinPedidoxCampanaClienteEnum {
    Prospecto = 1,
    Nuevo = 1,
    Activo = 1,
    PosibleEgreso = 1,
...
/// </summary>
export enum GruposUsuariosEnum {
    EmpresariasWeb = 50,
    Administrador = 51,
    ServicioCliente = 12,
...
export enum ParametrosEnum {
    ...
    /// </summary>
    ValorFletePuntos = 79,
    ///Valor monto minimo para pagos con credito
    /// </summary>
    ValorMinimoParaPagoCredito = 100
...
/// </summary>
export enum ProcesoClienteEnum {
    /// <summary>
    /// CreacionCliente = 0
    /// </summary>
...
/// </summary>
export enum PorcentajesMatrizEnum {
    /// <summary>
...
/// Estados Empresarias (Respetar los valores de la base de datos)
/// </summary>
export enum ComoTeEnterasteEnum {
    AtravesdeFacebook = 1,
...
/// </summary>
export enum TipoPedidoMinimoEnum {
    Nivi = 1,
    Pisame = 2,
    Mezcla = 3
}
...
/// Catalogo de Interes
/// </summary>
export enum CatalogoInteresEnum {
    Nivi = 1,
    Pisame = 2,
    Ambos = 3
}
