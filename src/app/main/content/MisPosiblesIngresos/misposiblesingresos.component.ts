...
@Component({
    moduleId: module.id,
    selector: "misposiblesingresos",
    templateUrl: "misposiblesingresos.component.html",
    styleUrls: ["misposiblesingresos.component.scss"],
})
export class MisPosiblesIngresosComponent implements OnInit {
    displayedColumns = [
        "imagenEmpresaria",
        "NombreCompleto",
        "Detalle",
    ...
    ngOnInit() {
        ...
        objCliente.IdEstadosCliente = 23;
