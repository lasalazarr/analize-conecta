...
@Component({
    moduleId: module.id,
    selector: 'registroempresaria',
    templateUrl: 'registroempresaria.component.html',
    styleUrls: ['registroempresaria.component.scss'],
    encapsulation: ViewEncapsulation.None
})
export class RegistroEmpresariaComponent implements OnInit {
    NumeroDocumento: any;
    PrimerNombre: any;
    PrimerApellido: any;
    FechaNacimiento: any;
    ...
    public mostrarValidarEmail:boolean=false
    public mostrarValidarCel:boolean=false
    ...
    constructor(private formBuilder: FormBuilder,
        ...
        private bottomSheetRef: MatBottomSheetRef<RegistroEmpresariaComponent>,
    ...
    ngOnInit() {
        ...
        this.maxDate = new Date(2002, 11, 31);

        this.MaskedNumber = GenerateMask.numberMask;
        this.MaskedNumberNoDecimal = GenerateMask.Nodecimal;

        this.SessionUser.IdGrupo = this.data.IdGrupo;
        this.SessionUser.IdLider = this.data.Lider;
        this.SessionUser.IdVendedor = this.data.Vendedor;
        this.LiderSeleccionado = this.data.Lider;
    ...
    EnviarInfo() {
        ...
        try {
            ...
            objCliente.ComoLlegar = this.addresses[0].Direccion;
            ...
            objCliente.Zona = this.SessionUser.IdVendedor;
            ...
            objCliente.Lider = this.data.Lider;
            ...
            objCliente.DocumentoDistribuidor = this.form.value.NumeroDocumento;
                ...
                objCliente.CreadoPor = "EMPRESARIA";
                    ...
                    if (objClienteResp != null) {
                        if (objClienteResp.IdEstadosCliente == EstadosClienteEnum.InactivaEcu) {
                            ...
                            const dialogRef = this.dialog.open(ModalPopUpComponent, {
                                ...
                                panelClass: 'dialogInfocustom',
                                height: 'auto',
                                data: { TipoMensaje: "", Titulo: "Atención", Mensaje: "El usuario ya se encuentra registrado , por favor inicie sesión o recupere contraseña." }
                            });
                            this.bottomSheetRef.dismiss()
                        }
                    }
                ...
                .subscribe((x: E_Cliente) => {
                    ...
                    if (x.Error == undefined) {
                        ...
                        const dialogRef = this.dialog.open(ModalPopUpComponent, {
                            panelClass: 'dialogInfocustom',
                            width: '450px',
                            data: { TipoMensaje: "Ok", Titulo: "Registro Empresaria", Mensaje: "Se registro la empresaria exitosamente! Para ingresar al sistema puedes realizarlo con tu identificación como usuario y contraseña" }
                        });
