...
@Component({
    moduleId: module.id,
    selector: 'ventasj',
    templateUrl: 'ventasj.component.html',
    styleUrls: ['ventasj.component.scss']
})

export class VentasJohnsonComponent implements OnInit {
    displayedColumns: string[] = ['Fecha',  'Venta'];
    ...
    videoSource = "assets/video/jj.mp4"
    ...
    ngOnInit() {
        ...
        if (this.SessionUser.IdGrupo == "60") {
            this.VentasService.VentaspromoJJ(objVentas)
