...
@Component({
    moduleId: module.id,
    selector: "misegresos",
    templateUrl: "misegresos.component.html",
    styleUrls: ["misegresos.component.scss"],
})
export class MisEgresosComponent implements OnInit {
    displayedColumns = [
        "imagenEmpresaria",
        "NombreCompleto",
        "Detalle",
