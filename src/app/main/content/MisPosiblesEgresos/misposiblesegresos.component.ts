...
@Component({
    moduleId: module.id,
    selector: "misposiblesegresos",
    templateUrl: "misposiblesegresos.component.html",
    styleUrls: ["misposiblesegresos.component.scss"],
})
export class MisPosiblesEgresosComponent implements OnInit {
    displayedColumns = [
        "imagenEmpresaria",
        "NombreCompleto",
        "Detalle",
